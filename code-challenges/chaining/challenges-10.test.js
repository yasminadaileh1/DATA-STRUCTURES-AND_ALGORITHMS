...
const totalSum = (input) => {
    ...
    return input.reduce((accumulator, currentValue) => {
        return (accumulator + currentValue.reduce((secAccumulator, secCurrentValue) => {
            return secAccumulator = secAccumulator + secCurrentValue;
        }, 0));
    }, 0);
};
...
let findMaleAndFemale = (data) => {
    ...
    return data.reduce((acccumulator, currentValue) => {
        return currentValue.gender === 'female' || currentValue.gender === 'male' ?
            acccumulator === '' ?
            acccumulator + currentValue.name : acccumulator +
            ' and ' + currentValue.name : acccumulator;
    }, '');
};
...
let findShortest = (data) => {
    ...
    return data.reduce((acccumulator, currentValue) => {
        return acccumulator === '' ?
            currentValue.name : acccumulator.length < currentValue.name.length ?
