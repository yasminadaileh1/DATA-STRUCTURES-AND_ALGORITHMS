...
const listFoods = (recipe) => {
    ...
    recipe.ingredients.forEach((value) => {
        const much = value.slice(value.indexOf(" ") + 1);
        const many = much.slice(much.indexOf(" ") + 1);
        result.push(many);
    });
    return result;
};
...
// this is working in repl I don't know who to solve this issue!
